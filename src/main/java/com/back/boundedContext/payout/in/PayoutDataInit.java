...
public class PayoutDataInit {
    ...
    public void runCollectPayoutItemsBatchJob() {
        ...
        try {
            JobExecution execution = jobOperator.start(payoutColletItemsJob, jobParameters);
